...
[Files]
Source: "[APP Folder]\nw\nw.exe"; Excludes: ".git"; DestDir: "{app}"; Flags: ignoreversion
Source: "[APP Folder]*"; Excludes: ".git"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
